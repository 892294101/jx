<template>
  <el-card>
    ...
    <el-form size="mini" :inline="true" :model="queryParams">
      ...
      <el-form-item prop="deptStatus" label="部门状态">
        <el-select class="searchList" size="mini" placeholder="请选择部门状态" v-model="queryParams.deptStatus" clearable>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button plain type="primary" icon="el-icon-plus" size="mini"
                   @click="addDeptDialogVisible = true" v-authority="['base:dept:add']">新增
        </el-button>
      </el-col>
      <el-col :span="1.5">
    ...
    <el-table size="mini" border stripe :header-cell-style="{ background: '#eef1f6', color: '#606266' }" v-if="refreshTable"
      ...
      <el-table-column label="部门类型" prop="deptType" width="auto" min-width="120">
      ...
      <el-table-column label="部门状态" prop="deptStatus" width="auto" min-width="120">
        <template slot-scope="scope" width="auto" min-width="120">
    ...
    <el-dialog title="新增部门" :visible.sync="addDeptDialogVisible" width="30%" @close="addDeptDialogClosed">
      <el-form size="mini" :model="addDeptForm" :rules="addDeptFormRules" ref="addDeptFormRefForm" label-width="80px">
    ...
    <el-dialog title="编辑部门" :visible.sync="editDeptDialogVisible" width="30%">
      <el-form size="mini" :model="deptInfo" :rules="editDeptFormRules" ref="editDeptFormRefForm" label-width="80px">
        <el-form-item label="部门类型" prop="deptType">
