  ...
  <el-card>
    ...
    <el-form size="mini" :model="queryParams" :inline="true">
      ...
      <el-form-item label="岗位状态" prop="postStatus">
        <el-select class="searchList" size="mini" placeholder="请选择岗位状态" v-model="queryParams.postStatus" clearable>
...
<!--    <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange"
    ...
    <el-dialog title="新增岗位" :visible.sync="addPostDialogVisible" width="30%" @close="addPostDialogClosed">
      <el-form size="mini" label-width="80px" ref="addPostFormRefForm" :rules="addPostFormRules" :model="addPostForm">
        <el-form-item label="岗位名称" prop="postName">
    ...
    <el-dialog title="编辑岗位" :visible.sync="editPostDialogVisible" width="30%" @close="editPostDialogClosed">
      <el-form size="mini" label-width="80px" ref="editPostFormRefForm" :rules="editPostFormRules" :model="editPostForm">
        <el-form-item label="岗位名称" prop="postName">
